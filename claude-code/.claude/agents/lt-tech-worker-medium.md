---
name: lt-tech-worker-medium
description: 長任務 B 線技術實作子代理（sonnet／effort medium，基準檔）。只由 long-task-orchestrator 主線依狀態檔派工、不自動選用：在授權範圍內實作前端邏輯、後端、資料整合、修復與必要測試，回報候選版與驗證輸出；主線驗收。
model: sonnet
effort: medium
